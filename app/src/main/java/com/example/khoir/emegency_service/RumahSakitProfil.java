 ...
 */
public class RumahSakitProfil extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.profil_rs);//menpilkan data profil ke layout profil

        TxtViewId = (TextView) findViewById(R.id.id_rs);
        TxtViewNama = (TextView) findViewById(R.id.nama_rs);
        ...
        String isi_id_rs = b.getString("id_rs");
        String isi_nama_rs = b.getString("nama_rs");
        ...
        TxtViewId.setText(isi_id_rs);
        TxtViewNama.setText(isi_nama_rs);
        ...
        maps.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(RumahSakitProfil.this, MapsActivity.class);
